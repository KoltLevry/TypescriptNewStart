...
const Task = () => {
    ...
    const handleClickSave = () => {
        ...
        // ! null (часто пишеться як нал в розмовній мові) — це значення, яке вказує на відсутність об'єкта. Це не те саме, що й undefined, яке означає, що змінна була оголошена, але їй не було присвоєно значення.
    }
